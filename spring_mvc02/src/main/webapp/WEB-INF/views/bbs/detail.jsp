				...
				<tr>
					...
					<c:choose>
							...
							<c:otherwise>
									...
									<img src="resources/upload/${bvo.f_name}" style="width: 80px;"></a>
									<br>${bvo.f_name }</td>
							</c:otherwise>
					</c:choose>
				</tr>
	...
	<div style="display: table; margin: 0 auto;">
			...
			<div style="border: 1px solid #cc00cc; width: 580px; margin: 5px; padding: 5px;">
					<form action="/comment_delete" method="post">
							...
							<p> 날짜 : ${k.write_date}</p>
							<%-- 실제는 로그인 성공 후, 관리자이거나 글 쓴 본인인 경우에만 삭제가능하게 해야 함 --%>
							<input type="submit" value="댓글삭제">
							<%-- MVC로 했기 때문에 컨트롤러 가서 DB 삭제 후 다시 이곳으로 와야 한다. (나중에 ajax로 변경하자) --%>
