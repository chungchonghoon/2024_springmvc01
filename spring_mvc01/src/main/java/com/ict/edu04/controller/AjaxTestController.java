...
// RestController 은 servlet-context.xml로 리턴하지 않고 브라우저에 출력한다.
...
public class AjaxTestController {
	...
	@ResponseBody
// 반환형이 String 인 경우 문서 타입을 contentType = "text/html" 로 변경시키자
	...
	@RequestMapping(value = "/test03", produces = "application/xml; charset=utf-8")
	@ResponseBody
	public String Xml_Exam02() {
		StringBuffer sb = new StringBuffer();
		BufferedReader br = null;
		try {
			// 웹 상의 존재하는 xml 을 가져오기
	...
	public String Xml_Exam03() {
		...
		try {
	        ...
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=6WgSWmzKOenWpUh%2BBBzSkWk2yBuoLIcY%2F9cg4Cc1KaTt96UQNPPUHHpG353%2BYdWw0HCCjEyVVCqz%2BSKDOe2m3w%3D%3D");/*자신의 서비스키 -> Service Key* /
...
public String Json_Exam03() {
	...
	try {
        ...
        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=6WgSWmzKOenWpUh%2BBBzSkWk2yBuoLIcY%2F9cg4Cc1KaTt96UQNPPUHHpG353%2BYdWw0HCCjEyVVCqz%2BSKDOe2m3w%3D%3D"); /*Service Key*/
        urlBuilder.append("&" + URLEncoder.encode("pageNo","UTF-8") + "=" + URLEncoder.encode("1", "UTF-8")); /*페이지번호*/
        urlBuilder.append("&" + URLEncoder.encode("numOfRows","UTF-8") + "=" + URLEncoder.encode("10", "UTF-8")); /*한 페이지 결과 수*/
